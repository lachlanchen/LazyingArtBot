...
function parseThreadId(ctx: FinalizedMsgContext): string | undefined {
...
export function toEmailCaptureInput(ctx: FinalizedMsgContext): CaptureInput {
  const content =
