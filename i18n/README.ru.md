...
| Основная LAB-оркестрация           | `orchestral/` + `orchestral/prompt_tools/` |
...
- `orchestral/prompt_tools` указывает на реализацию orchestral prompt-tools.
...
- Специализированные Codex prompt-tools: `orchestral/prompt_tools/`
